...
def run_inference(cfg, inference_scores_file, cm_plot_file):
  ...
  inference_score_dict['macs_tflite'] = inference_handler.get_macs_tflite()
...
def run_write_final_results(cfg, inference_scores_file, monitor_report_file, submission_results_file):
  ...
  submission_result_dict = {
    ...
    'macs_inference': 'N/A',
    'macs_tflite': 'N/A',
    'num_params_inference': 'N/A',
    'num_params_tflite': 'N/A',
  ...
  if inference_scores_file.is_file():
    ...
    # update submission dictionary
    submission_result_dict.update(inference_score_dict)
